...
urlpatterns = patterns('filebrowser.views',
    ...
    (r'^(?P<dir_name>[_a-zA-Z0-9./-]+)/generateimages/$', 'generateimages'),
    (r'^(?P<dir_name>[_a-zA-Z0-9./-]+)/generateimages/(?P<file_name>[a-zA-Z0-9._-]+)', 'generateimages'),
    ...
    (r'^generateimages/$', 'generateimages'),
    (r'^generateimages/(?P<file_name>[a-zA-Z0-9._-]+)', 'generateimages'),
