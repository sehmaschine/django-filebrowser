...
class FileObjectPathTests(TestCase):
    ...
    def test_windows_paths(self):
        ...
        f = FileObject('C:\\path\\to\\media\\uploads\\testdir\\testfile.jpg', media_root=filebrowser.base.MEDIA_ROOT, directory=filebrowser.base.DIRECTORY)
    ...
    def test_posix_paths(self):
        ...
        filebrowser.base.DIRECTORY = 'uploads/'
        filebrowser.base.MEDIA_URL = '/media/'
        f = FileObject('/path/to/media/uploads/testdir/testfile.jpg', media_root=filebrowser.base.MEDIA_ROOT, directory=filebrowser.base.DIRECTORY)
