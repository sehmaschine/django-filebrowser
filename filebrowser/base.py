...
# FILEBROWSER IMPORTS
from filebrowser.core.base import FileObject as CoreFileObject
...
class FileObject(CoreFileObject):
    """
    The FileObject represents a file (or directory) on the server and
    ...
    def _original(self):
        if self.is_version:
            return CoreFileObject(get_original_path(self.path, site=self.site), site=self.site)
        return self
    ...
    def version_generate(self, version_suffix):
        ...
        return CoreFileObject(version_path, site=self.site)
