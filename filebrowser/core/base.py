...
from filebrowser.core.functions import get_file_type, url_join, sort_by_attr, path_strip, url_strip
...
class FileListing(object):
    ...
    An example::
        ...
        import os
        from filebrowser.core.settings import MEDIA_ROOT, DIRECTORY
...
class FileObject(object):
    ...
    def exists(self):
        return self.site.storage.isdir(self.path) or self.site.storage.isfile(self.path)
