...
# FILEBROWSER IMPORTS
from filebrowser.core.base import FileListing
from filebrowser.core.sites import *
from filebrowser.core.sites import FileBrowserSite as CoreFileBrowseSite
...
class FileBrowserSite(CoreFileBrowseSite):
    
    file_class = FileObject

    def _get_settings_var(self, directory):
        settings_var = super(FileBrowserSite, self)._get_settings_var(directory)
        # Versions
    ...
    def get_urls(self):
        ...
        urlpatterns = super(FileBrowserSite, self).get_urls()        
    ...
    def _get_filter_regex(self):
        filter_re = super(FileBrowserSite, self)._get_filter_regex()
    ...
    def delete(self, request):
        ...
        return super(FileBrowserSite, self).delete(request)
    ...
    def browse(self, request, template='filebrowser/index.html',
        ...
        return super(FileBrowserSite, self).browse(request, template,
    ...
    def detail(self, request, template='filebrowser/detail.html'):
        ...
        return super(FileBrowserSite, self).detail(request, template)

    def version(self, request, template='filebrowser/version.html'):
        """
        Version detail.
        """
        query = request.GET
...
site = FileBrowserSite(name='filebrowser', app_name='filebrowser')
